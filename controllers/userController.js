...
export const register = async (req, res) => {
  try {
    ...
    cloudinaryInstance.uploader.upload(req.file.path, async (err, result) => {
      ...
      sendMail(
        email,
        "Welcome to Medico Super Speciality Hospital",
        `Hi ${firstName} ${lastName} We are delighted to have you join our community. 
...
export const getuser = async (req, res) => {
  try {
    ...
    console.log(error);
    res.json({ message: "can't get user details", success: false }); 
  }
};
